...
router.post('/auth/register', 
    ...
    // Middleware para validar los errores de la peticion
    handleInputErrors,
    // Si no existen errores, se ejecuta la funcion createAccount
    createAccount);
...
router.post('/auth/login',
    ...
    // Middleware para validar los errores de la peticion|
    handleInputErrors,
    // Si no existen errores, se ejecuta la funcion login
    login);
